    ...
    return (
        <div className='w-[70%] bg-purple-500 rounded-md shadow-md shadow-slate-500 active:shadow-lg active:shadow-slate-500 transition-all'>
            ...
            <div className='bg-red-500 flex flex-col rounded-b-md items-center justify-center p-2 space-y-2' >
                ...
                <button onClick={()=>openInformation()} className=' w-[50%] flex items-center justify-center text-purple-500 font-bold text-lg rounded-md bg-white px-3 py-1 shadow-sm cursor-pointer active:scale-95 transition-all ' type='button' >
                    Mas Info
                </button>
            </div>
        </div>
