...
const PokemonCard = ({pokemonInfo}) => {
    ...
    return (
        <div className='w-[70%] bg-purple-500 rounded-md shadow-md shadow-slate-500 active:shadow-lg active:shadow-slate-500 lg:hover:shadow-lg lg:hover:shadow-slate-500 transition-all md:w-full cursor-pointer'>
